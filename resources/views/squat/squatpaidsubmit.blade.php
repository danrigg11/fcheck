      ...
      <div class="col-md-10 order-md-1">
        ...
        <form class="was-validated">
            ...
            <div class="card-body">
              ...
              <div class="form-group mb-1">
                <div class="input-group">
                  ...
                  <label class="form-control" aria-label="Text input with checkbox" for="Erik">Erik<a class="float-right pr-2" href="#">See Trainer</a></label>
                </div>
              </div>
              ...
              <div class="form-group mb-1">
                <div class="input-group">
                  ...
                  <label class="form-control" aria-label="Text input with checkbox" for="Stan">Stan<a class="float-right pr-2" href="#">See Trainer</a></label>
                </div>
              </div>
            </div>
          </div>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <ul style="height: auto; max-height: 100px; overflow-x: hidden;" role="menu">
                      <li>Tim doe <span class="text-danger">500 Points</span><a class="float-right pr-2" href="#">See Trainer</a></li>
                      <li>mike chang <span class="text-danger">497 Points</span><a class="float-right pr-2" href="#">See Trainer</a></li>
                      <li>stan twist <span class="text-danger">490 Points</span><a class="float-right pr-2" href="#">See Trainer</a></li>
                      <li>alex nah <span class="text-danger">488 Points</span><a class="float-right pr-2" href="#">See Trainer</a></li>
                      <li>dan Rigg <span class="text-danger">478 Points</span><a class="float-right pr-2" href="#">See Trainer</a></li>
                      <li>Ebony Nash <span class="text-danger">450 Points</span><a class="float-right pr-2" href="#">See Trainer</a></li>
                    </ul>
                  </div>
                </li>
          ...
          <div class="form-group">
            ...
            <small id="passwordHelpInline" class="text-muted">Trainer will get a thurther 5-10 minutes once accepted case depending on viedo length.</small>
          </div>
          ...
          <div class="custom-control custom-checkbox mb-3">
            ...
            <label class="custom-control-label" for="customControlValidation2">I accept T&C.</label>
            <div class="invalid-feedback">You must agree to these terms to submit.</div>
          </div>
